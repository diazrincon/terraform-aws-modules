...
| <a name="input_application_host_name"></a> [application\_host\_name](#input\_application\_host\_name) | n/a | `string` | n/a | yes |
| <a name="input_application_version"></a> [application\_version](#input\_application\_version) | n/a | `string` | n/a | yes |
...
| <a name="input_frontend_bucket_path"></a> [frontend\_bucket\_path](#input\_frontend\_bucket\_path) | n/a | `string` | n/a | yes |
